    ...
    <Dialog open={open} onClose={handleClose} fullWidth maxWidth='lg'>
      ...
      <DialogContent>
        ...
        <Typography variant='body2'>
          ...
          которой находится стол с различными приборами и конструкциями. Приборы
          ...
          Также вам доступно <b>управление камерой</b>: вращение, расстояние до
          объекта и смена объекта просмотра (подробнее ниже). Вращение камерой
          осуществляется с помощью зажатия правой кнопки мыши (ПКМ) и движения
          ее в стороны, а расстояние до объекта - с помощью зажатия средней
          кнопки мыши (СКМ) и движения мыши в сторону.
          <br />
          <br />
